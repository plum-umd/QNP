...
In VOQC \cite{VOQC}, the QPE reuse in the Shor's proof was done by proving many new theorems that were not originally required in the QPE proofs. QNP opens a windows \ynote{grammar/typo?} towards the reusable proofs for verifying new algorithms.
