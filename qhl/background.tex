...
\ynote{If we're working under page limit, people in the crypto community often move their ``preliminary'' section to the appendix. How do we feel about that in the PL community?}
...
\ynote{This doesn't feel like it should be in backgrounds. Treating $\tnort$ and $\thadt$ as program types seems like a novelty to me... isn't it?}
...
\ynote{Wait, that's what QRAM means? We should double check; I had a different picture somehow.}
